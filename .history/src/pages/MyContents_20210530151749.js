        ...
        <div className="inner-box">
          <div className="content-item">
            ...
            <div className="content-txt">
              <h4 className="content-info">date: 2020 8/18</h4>
              <h4 className="content-info">production: ブロック崩し</h4>
              <p content-info>
          ...
          <div className="content-item">
            ...
            <div className="content-txt">
              <h4 className="content-info">date: 2020 10/18</h4>
              <h4 className="content-info">production: Youtube Demo</h4>
              <p>
          ...
          <div className="content-item">
            ...
            <div className="content-txt">
              <h4 className="content-info">date: 2020 11/21</h4>
              <h4 className="content-info">production: Pig Games</h4>
              <p>
