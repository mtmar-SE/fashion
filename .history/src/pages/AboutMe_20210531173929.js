...
import Me from "../accessories/img/Me.jpeg";
          ...
          <div className="wrapme">
            ...
            <div className="detail-me">
              ...
              <p className="desc-me">
                ...
                そこでHTML、CSS、JavaScript、Reactを学び、簡易的なWebアプリケーション（ホームページ、チャットアプリ、Todoアプリ）を作成しました。スクール卒業後は更なる技術力の発展の為、Udemyを活用し10個ほどのWebアプリケーションを開発しました。
                <br></br>
